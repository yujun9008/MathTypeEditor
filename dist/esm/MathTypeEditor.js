...
const MathEditor = ({ defaultValue, onChange, style }) => {
    ...
    const renderPreview = (text) => {
        ...
        if (!text.match(regex)) {
            ...
            if (seemsLikeLatex) {
                try {
                    return katex.renderToString(text, { throwOnError: true, strict: false, trust: true });
                }
                catch (e) {
    ...
    return (_jsxs("div", { className: "MathEditor", style: style, children: [_jsxs("div", { className: "mathBody", children: [_jsx("div", { className: "modeSegmented", children: _jsx(Segmented, { value: editMode, onChange: val => handleModeChange(val.toString()), options: [
                                { label: 'MathType 编辑', value: 'mathlive' },
                                { label: 'LaTex 编辑', value: 'latex' },
                            ] }) }), _jsx("div", { className: "editContent", children: editMode === 'mathlive'
                            ? (_jsxs("div", { className: "editKatax", children: [_jsx("p", { className: "title", children: "\u516C\u5F0F\u7F16\u8F91\u533A\u57DF\uFF08\u652F\u6301\u76F4\u63A5\u7C98\u8D34\u516C\u5F0F\uFF09\uFF1A" }), _jsx("math-field", { ref: mfRef, className: "mathField" })] }))
                            : (_jsxs(_Fragment, { children: [_jsxs("div", { className: "editKatax", children: [_jsx("p", { className: "title", children: "latex\u7F16\u8F91\u533A\u57DF\uFF1A\u6682\u4E0D\u652F\u6301\u4E2D\u6587\u5B57\u7B26\uFF0C\u8BF7\u4E0D\u8981\u8F93\u5165\u4E2D\u6587\u5B57\u7B26" }), _jsx(Input.TextArea, { value: latexVal, onChange: onLatexChange, style: { height: '75px' } })] }), _jsxs("div", { className: "previewKatax", children: [_jsx("p", { className: "previewTitle", children: "\u516C\u5F0F\u9884\u89C8\uFF1A" }), _jsx("div", { dangerouslySetInnerHTML: {
                                                    __html: renderPreview(latexVal),
                                                } })] })] })) })] }), _jsx(Tabs, { activeKey: activeKey, onChange: setActiveKey, className: "mathTabs", popupClassName: "MathEditorMorePopup", items: KATEXLIST.map(i => ({
                    label: i.name,
                    key: i.name,
                    children: (_jsx(_Fragment, { children: i.children.map((c, idx) => (_jsx("div", { className: "kataxBody", onClick: () => onSelect(c), dangerouslySetInnerHTML: {
